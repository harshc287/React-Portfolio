        ...
        <div className="row gy-5 mb-5">
          ...
          <div className="col-lg-6">
            <div className="glass-card p-4 p-md-5 h-100 fade-in-up">
              <h3 className="mb-4 text-secondary">My Journey</h3>
              ...
              {highlights.map((item, index) => (
                <div className="col-md-6" key={index}>
                  <div className="card h-100 border-0 shadow-sm hover-lift p-4">
                    ...
                    <p className="text-dark-80 mb-0">{item.description}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            {skills.map((skill, index) => (
              <div className="col-md-6 col-lg-3" key={index}>
                <div className="skill-item text-center p-4 glass-card">
                  ...
                  />
                  <h5 className="mb-2 text-secondary">{skill.name}</h5>
        ...
        <div className="row g-5">
          ...
          <div className="col-lg-6">
            <div className="glass-card p-4 p-md-5 h-100">
              <div className="d-flex align-items-center gap-3 mb-4">
                ...
                <h3 className="mb-0 text-secondary">Experience</h3>
              </div>
              ...
              {experiences.map((exp, index) => (
                <div key={index} className="timeline-item mb-4">
                  <div className="d-flex justify-content-between align-items-start mb-2">
                    <div>
                      <h5 className="mb-1 text-secondary">{exp.role}</h5>
                  ...
                  <p className="text-white-60 lead fs-6 ">{exp.description}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="col-lg-6">
            <div className="glass-card p-4 p-md-5 h-100">
              <div className="row g-4">
                <div className="col-md-6">
                  <div className="text-center p-3">
                    ...
                    <p className="lead text-white mb-1 fs-6">B.Tech in Data Science</p>
                    <p className="fw-bold text-white fs-6">IPS Academy, Indore</p>
                ...
                <div className="col-md-6">
                  <div className="text-center p-3">
                    ...
                    <p className="text-white-80 mb-1 lead fs-6">Based in</p>
                    <p className="fw-bold text-white fs-6">Pune, Maharashtra</p>
              ...
              <div className="mt-4">
                <h5 className="mb-3 text-secondary">Languages</h5>
